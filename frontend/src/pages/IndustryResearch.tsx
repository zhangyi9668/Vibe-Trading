...
export function IndustryResearch() {
  ...
  return <div className="mx-auto max-w-7xl px-8 py-8">
    ...
    <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-3">
      {industries.map((industry) => <Link key={industry.slug} to={industry.slug === "semiconductor" ? "/semiconductor-research" : `/industry-research/${industry.slug}`} className="group rounded-xl border border-border bg-card p-5 transition hover:border-primary/50 hover:bg-muted/30">
